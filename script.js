document.addEventListener('DOMContentLoaded', (event) => {
    ...
    addDangZone(2277 , 2554, '<b>Опасное место №6</b> <br> Большое скопление гончих или накеров независимо от экипировки')
    addDangZone(549 , 2381, '<b>Опасное место №7</b> <br> Большое скопление гончих или накеров независимо от экипировки')
    // Чертежи
